...
window.full_permissions=false;
window.tags_display_allowed=false;
/* GLOBALS END */
/*!
...
(function() {
  ...
  WebpageImporter = (function(superClass) {
        ...
        return function() {
          ...
          return _this.find_images_to_convert_to_datauri(function() {
            ...
            return _this.embed_css(function() {
              ...
              return callback(_this.html_content);
            });
          });
        };
      })(this));
    ...
    WebpageImporter.prototype.convert_next_image_to_datauri = function(callback) {
      var current_image_size, image_sizes, resolved_src, src, src_list;
    ...
    WebpageImporter.prototype.is_stylesheet_url_valid = function(stylesheet_url) {
    ...
    WebpageImporter.prototype.process_stylesheet_content = function(stylesheet_content, stylesheet_url) {
      var elements, style;
    ...
    WebpageImporter.prototype.clone_html = function() {
      ...
      return this.head = document.head.cloneNode(true);
    };

    WebpageImporter.prototype.add_data_attributes = function() {
      var images;
      images = $('img');
